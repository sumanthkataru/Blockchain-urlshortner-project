This project is a URL shortener implemented as a smart contract on the Ethereum blockchain. It uses React for the front-end interface and Solidity for the smart contract logic.
